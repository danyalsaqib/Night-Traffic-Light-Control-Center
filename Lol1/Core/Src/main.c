...
osThreadId OverrideSwitchHandle;
osThreadId TrafficControl1Handle;
osThreadId SensorDataHandle;
osSemaphoreId SensorStateHandle;
/* USER CODE BEGIN PV */
...
/* USER CODE BEGIN Header_OverwrideSwitch */
/**
  * @brief  Function implementing the OverrideSwitch thread.
...
/* USER CODE BEGIN Header_StartTrafficControl1 */
/**
* @brief Function implementing the TrafficControl1 thread.
* @param argument: Not used
* @retval None
*/
...
/* USER CODE BEGIN Header_StartSensorData */
/**
* @brief Function implementing the SensorData thread.
* @param argument: Not used
* @retval None
*/
